...
var FrontuRegistry = /** @class */ (function () {
    function FrontuRegistry() {
        this.store = {};
        this.willMount = {};
    }
    FrontuRegistry.prototype.define = function (name, component) {
        this.store[name] = component;
    };
    return FrontuRegistry;
}());
var Frontu = /** @class */ (function () {
    function Frontu() {
    }
    Frontu.COMPONENT_TYPE = 999;
    Frontu.Registry = new FrontuRegistry();
    return Frontu;
}());
